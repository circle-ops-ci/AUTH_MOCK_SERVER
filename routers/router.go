...
func init() {
	...
	beego.Router("/v1/mock/users/remove", &controllers.OuterController{}, "DELETE:DeleteUser")
	beego.Router("/v1/mock/healthy", &controllers.OuterController{}, "GET:ServerHealthy")
}
